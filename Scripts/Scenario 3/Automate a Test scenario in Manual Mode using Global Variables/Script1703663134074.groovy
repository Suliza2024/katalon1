...
WebUI.setText(findTestObject('Object Repository/sce2/Page_Create New Customer Account/input_firstname'), GlobalVariable.F_name)

WebUI.setText(findTestObject('Object Repository/sce2/Page_Create New Customer Account/input_lastname'), GlobalVariable.L_name)

WebUI.setText(findTestObject('Object Repository/sce2/Page_Create New Customer Account/input_email'), GlobalVariable.email)
